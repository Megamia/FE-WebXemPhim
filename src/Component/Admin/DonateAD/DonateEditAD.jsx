...
const DonateEditAD = ({ handleCloseSelected, donate }) => {
  const [imgPreview, setImgPreview] = useState(`../../img/${donate.img}` || "");
  const [imgFile, setImgFile] = useState(donate.img || null);
  const [donatename, setdonatename] = useState(donate.donatename || null);
  const [description, setdescription] = useState(donate.description || null);
  const [price, setprice] = useState(donate.price || null);
