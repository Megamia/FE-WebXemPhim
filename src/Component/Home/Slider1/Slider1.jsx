        ...
        {movieData.map((movie, index) => {
          return (
            <div
              ...
              key={index}
            >
              <div className="bg-black absolute top-[-10px] left-[-10px] blur opacity-35 w-[60%] h-[110%] flex px-[20px] py-[10px] flex-col" />
                ...
                <div className=" text-[20px] flex flex-col ">
                  ...
                  <div className="text-white font-semibold flex flex-row items-center py-[5px]">
                    ...
                    <p className="truncate flex-grow text-[15px] text-[#D8D6D6]">
                      ...
                      {typeData.filter((type) => type.movieid === movie.movieid)
                        .length === 0 && <span className=" text-white"> Null</span>}
                    </p>
                  </div>
