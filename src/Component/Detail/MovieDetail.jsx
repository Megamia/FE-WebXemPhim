            ...
            <div className="bg-[#253238] flex justify-center w-full ">
                <div className="w-full md:max-w-[1280px] justify-center rounded flex-col bg-[#141414] p-[20px] mt-[100px] xl:mt-[120px] xl:rounded">
                    ...
                    <div className="table table-fixed w-full">
                            ...
                            <main className="pt-[20px] lg:table-cell lg:pr-[20px] flex-row h-[65.7vh]">
                                ...
                                <div className='bg-[#1F282D] w-full rounded'>
                                    <div className='bg-[#141414] w-full px-[10px] pt-[20px] mb-[20px] flex relative'>
                                        <div className={`px-[3px] font-semibold text-[15px] flex pb-[20px] mr-[40px] relative mb-[-1px] ${activeTab === 0 ? 'border-[#B5E745] border-b-4 text-[#B5E745] arrow-down' : 'text-white'
                                            }`}
                                            onClick={() => handleTabClick(0)}
                                        >
                                            <HiDocumentText className={`text-[25px] duration-200 ease-in-out mr-2 ${activeTab === 0 ? 'text-[#B5E745]' : 'text-[#878A8B]'}`} />
                                            Thông tin phim
                                        </div>
                                        <div className={`px-[3px] font-semibold text-[15px] flex pb-[20px] mr-[40px] relative mb-[-1px] ${activeTab === 1 ? 'border-[#B5E745] border-b-4 text-[#B5E745] arrow-down' : 'text-white'
                                            }`}
                                            onClick={() => handleTabClick(1)}
                                        >
                                            <MdVideoCall className={`duration-200 ease-in-out text-[25px] mr-2 ${activeTab === 1 ? 'text-[#B5E745]' : 'text-[#878A8B]'}`} />
                                            Trailer
                                        </div>
                                        <div className={`px-[3px] font-semibold text-[15px] flex pb-[20px] mr-[40px] relative mb-[-1px] ${activeTab === 2 ? 'border-[#B5E745] border-b-4 text-[#B5E745] arrow-down' : 'text-white'
                                            }`}
                                            onClick={() => handleTabClick(2)}
                                        >
                                            <IoMdPhotos className={`duration-200 ease-in-out text-[25px] mr-2 ${activeTab === 2 ? 'text-[#B5E745]' : 'text-[#878A8B]'}`} />
                                            Hình ảnh
                                        </div>
                                    </div>
                                    <div className={`px-[20px] pb-[20px] text-[#D7D7D7] ${activeTab === 0 ? 'flex animate-zoomIn' : 'hidden'}`}>
                                        <div className='float-left w-[48%] mr-[2%] relative'>
                                            <ul className='text-[15px]'>
                                                ...
                                                <li className='relative pl-[20px] py-[5px]'>
                                                    <FaRegCircleDot className='absolute text-[#B5E745] left-0 top-[8px]' />
                                                    <strong className='text-white'>Số người theo dõi:</strong>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div className={`px-[20px] ${activeTab === 1 ? 'flex animate-zoomIn' : 'hidden'}`}>
                                        <div className='mb-[20px] pt-[50%] w-full relative '>
                                            <div className='block'>
                                                <iframe width="560" height="315" className='absolute w-full h-full top-0 left-0 rounded' src={`${movie.trailerurl}`} frameborder="0" allowfullscreen=""></iframe>
                                            </div>
                                        </div>
                                    </div>
                                    <div className={`px-[20px] ${activeTab === 2 ? 'flex animate-zoomIn' : 'hidden'}`}>
                                        <div className='mb-[20px] w-full relative'>
                                            <div className='block'>
                                                <img className=' w-full bg-cover rounded' src={`../../upload/background/${movie.background}`}></img>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <aside className=" lg:table-cell align-top w-[300px]">
                            <Righter />
                        </aside>
                    </div>
                </div>
